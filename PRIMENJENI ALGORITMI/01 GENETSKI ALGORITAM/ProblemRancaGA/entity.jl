...
function generateEntity(genesLenght, C)
    return Entity(rand(0, genesLenght), 0, rand(0.1:C), false) # generise se random kamen, koji podrazumevano
                                                               # ne ispunjava uslov da bude u rancu
end
